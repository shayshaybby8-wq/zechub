...
Tight coupling was a big issue. Coupling means an indexer's internal architecture is heavily dependent on the specific protocol or requirements of the application consuming its data.
